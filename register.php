...
<body id="page-top" style="background: #CCCC;">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="h3 text-gray-900 mb-4">Daftar Akun</h1>
                    <h1 class="h5 text-primary">Pengguna Pengaduan Masyarakat</h1>
                    <br>
                  </div>

                  <form class="user" method="post" action="s_masyarakat.php">
                    <div class="form-group">
                      <input type="text" name="nik" placeholder="Masukan Nik" class="form-control" required="on" autocomplete="off">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <h4 class="h6 text-dark">Sudah punya akun? <a href="login.php" class="btn-link">Login</a> untuk masuk.</h4>
                  </div>
                    <hr>
                </div>
              </div>
