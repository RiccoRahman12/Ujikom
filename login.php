  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-6 col-lg-12">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5 mb-md-auto">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="h5 text-primary">Aplikasi Pengaduan Masyarakat</h1>
                    <br>
                  </div>
                  <?php 
                  if(isset($_GET['p'])){
                         if($_GET['p'] == "gagal"){
                          ...
                          echo "<script>alert('Perlu login untuk masuk kehalaman ini!')</script>";
                           }else if($_GET['p'] == "logout"){
                           echo "<script>alert('Logout Berhasil!')</script>";
                          }
                        } 
                    ?>
                  <form class="user" method="post" action="p_login.php">
                    ...
                    <hr>
                  <div class="text-center">
                    <h4 class="h6 text-dark">Belum punya akun? silahkan <a href="register.php" class="btn-link text-primary">daftar</a></h4>
                  </div>
                    <hr>
                </div>
              </div>
