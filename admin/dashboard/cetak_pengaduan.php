...
<head>
  ...
  <div class="card shadow">
            ...
            <h2 class="m-0  font-weight-bold text-dark " align="center">KELURAN CILEBUT BARAT </h2>
            ...
            <h5 class="m-0 font-weight-bold text-dark" align="center">LAPORAN DATA PENGADUAN</h5><br> 
              <div class="table-responsive">
                ...
                <br>
                  ...
                  $no = 1;
                  $sql = "SELECT * FROM pengaduan WHERE status = 'selesai' ORDER BY nama ASC";
